...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  KEYMAP( /* 0: colemak */
         KC_Q,   KC_W,   KC_F,    KC_P,    KC_G,                          KC_J,   KC_L,   KC_U,      KC_Y,    KC_MINUS, \
         KC_A,   KC_R,   KC_S,    KC_T,    KC_D,                          KC_H,   KC_N,   KC_E,      KC_I,    KC_O,     \
         KC_Z,   KC_X,   KC_C,    KC_V,    KC_B,                          KC_K,   KC_M,   KC_COMM,   KC_DOT,  KC_SLSH,  \
         KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC,   KC_LALT, KC_LCTL,   KC_SPC, KC_FN0, KC_SCOLON, KC_QUOT, KC_ENT    \
  ), KEYMAP( /* 1: qwerty */
         ...
         KC_1,    KC_2,          KC_3,         KC_4,          KC_5,                         KC_PGUP,  KC_HOME, KC_NO,   KC_END,   KC_EQL,    \
         KC_6,    KC_7,          KC_8,         KC_9,          KC_0,                         KC_PGDN,  KC_LEFT, KC_UP,   KC_RIGHT, KC_GRAVE,  \
         KC_UNDO, SHIFT(KC_DEL), CTRL(KC_INS), SHIFT(KC_INS), KC_INS,                       KC_LBRC,  KC_RBRC, KC_DOWN, KC_NO,    KC_BSLASH, \
         KC_FN1,  KC_NO,         KC_TRNS,      KC_TRNS,       KC_DEL,   KC_TRNS, KC_TRNS,   KC_SPACE, KC_FN0,  KC_NO,   KC_NO,    KC_FN3     \
  ), KEYMAP( /* 3: mouse */
         KC_NO,   KC_FN20, KC_FN21, KC_FN22, KC_NO,                       KC_FN18,   KC_FN15, KC_FN17, KC_FN16, KC_FN19, \
         KC_NO,   KC_FN13, KC_FN11, KC_FN14, KC_NO,                       KC_NO,     KC_FN9,  KC_FN7,  KC_FN10, KC_NO,   \
         KC_NO,   KC_NO,   KC_FN12, KC_NO,   KC_NO,                       KC_NO,     KC_NO,   KC_FN8,  KC_NO,   KC_NO,   \
         KC_TRNS, KC_NO,   KC_TRNS, KC_TRNS, KC_NO,   KC_TRNS, KC_TRNS,   KC_NO,     KC_FN2,  KC_NO,   KC_NO,   KC_FN16  \
         ...
         KC_NO,   KC_NO,   KC_TRNS,  KC_TRNS, KC_FN6,               KC_TRNS, KC_TRNS,   KC_NO,  KC_FN4, KC_NO,  KC_NO,  KC_NO   \
)};
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [3] = ACTION_LAYER_ON(4, ON_PRESS),  // switch to layer 4
